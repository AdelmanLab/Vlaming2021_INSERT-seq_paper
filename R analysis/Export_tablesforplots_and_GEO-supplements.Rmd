...
colnames(RNA_over_ctrl_totals)[match(c("runonRNA_4_splicingefficiency","runonRNA_5_splicingefficiency"),colnames(RNA_over_ctrl_totals))] <-   
                          c("runonRNA_1_splicingefficiency","runonRNA_2_splicingefficiency")
colnames(RNA_over_ctrl_totals)[match(c("chrRNA_2_total","chrRNA_3_total"),colnames(RNA_over_ctrl_totals))] <-
                          c("chrRNA_1_total","chrRNA_2_total")
colnames(RNA_over_ctrl_totals)[match(c("chrRNA_2_splicingefficiency","chrRNA_3_splicingefficiency"),colnames(RNA_over_ctrl_totals))] <-  
                          c("chrRNA_1_splicingefficiency","chrRNA_2_splicingefficiency")
...
alldata_WTscreens <- cbind(RNA_over_ctrl_averages[,c('totalRNA_average','chrRNA_average','runonRNA_average')],
                            sortseq_average,
                            ...
                            RNA_over_ctrl_totals[grep('chrRNA_._total',colnames(RNA_over_ctrl_totals))],
                            ...
                            RNA_over_ctrl_totals[grep('chrRNA_._splicingefficiency',colnames(RNA_over_ctrl_totals))],
                            RNA_over_ctrl_totals[grep('runonRNA_._splicingefficiency',colnames(RNA_over_ctrl_totals))]
                            )

write.table(alldata_WTscreens,'output/HV20220110_normalized_WTscreens.txt',sep="\t",quote=F,row.names=F)
```
...
alldata_WTscreens$chrRNA_average_pseudo <- alldata_WTscreens$chrRNA_average
alldata_WTscreens$chrRNA_average_pseudo[alldata_WTscreens$chrRNA_average_pseudo==0] <-
  min(alldata_WTscreens$chrRNA_average_pseudo[alldata_WTscreens$chrRNA_average_pseudo>0],na.rm=T)
...
```{r Figure 1}
# Genereate data tables for Figure 1c, 1d, 1e and 1f, ED1b, ED1c, as well as Figure 2c and ED Fig 2d
...
genomic_complete <- widetable_makeandsave_multi(x=genomicregions_complete,
                                                data_types=c("runonRNA_average_pseudo","chrRNA_average_pseudo",
                                                             "totalRNA_average_pseudo","sortseq_average"),
...
# Data in Figure 2a
write.table(alldata_RRP40KD_annotated[alldata_RRP40KD_annotated$unique_id %in% genomicregions_RRP40KDscreen$unique_id,
                                      c("unique_id","siNT_average_pseudo","siRRP40_average_pseudo")],
...
write.table(genomicregions_complete[,c("unique_id","runonRNA_average_pseudo","chrRNA_average_pseudo","totalRNA_average_pseudo")],
...
alldata_WT_annotated$fig2c <-     # Note: table generated in code block for Figure 1
    alldata_WT_annotated$unique_id %in% genomicregions_complete$unique_id[grep('PAS|6to179',genomicregions_complete$window)]
alldata_WT_annotated$EDfig2c <- alldata_WT_annotated$unique_id %in% genomicregions_complete$unique_id
alldata_WT_annotated$EDfig2d <-   # Note: table generated in code block for Figure 1
    alldata_WT_annotated$unique_id %in% genomicregions_complete$unique_id[grepl('PAS|6to179',genomicregions_complete$window) &  is.finite(genomicregions_complete$chrRNA_average_pseudo)]
alldata_WT_annotated$EDfig2e <- alldata_WT_annotated$unique_id %in% genomicregions_complete$unique_id[is.finite(genomicregions_complete$chrRNA_average_pseudo)]
```
...
write.table(data.frame(density(genomicregions_complete$totalRNA_average_pseudo_GCcorr[genomicregions_complete$category=="randomized_control"])[1:2]),
            file="PrismTables/3c_controls_densityplot",quote=F,row.names=F)
write.table(data.frame(density(genomicregions_complete$totalRNA_average_pseudo_GCcorr[genomicregions_complete$group=="mRNAs_6to179"])[1:2]),
            file="PrismTables/3c_mRNAs_6to179_densityplot",quote=F,row.names=F)
write.table(data.frame(density(genomicregions_complete$totalRNA_average_pseudo_GCcorr[genomicregions_complete$group=="lincRNAs_6to179"])[1:2]),
            file="PrismTables/3c_lincRNAs_6to179_densityplot",quote=F,row.names=F)
write.table(data.frame(density(genomicregions_complete$totalRNA_average_pseudo_GCcorr[genomicregions_complete$category=="mRNA_ends"])[1:2]),
            file="PrismTables/3c_mRNA_ends_densityplot",quote=F,row.names=F)
# Export tables for density plot 3d
write.table(data.frame(density(genomicregions_complete$totalRNA_average_pseudo_GCcorr[genomicregions_complete$group=="uaRNAs_6to179"])[1:2]),
            file="PrismTables/3d_uaRNAs_6to179_densityplot",quote=F,row.names=F)
write.table(data.frame(density(genomicregions_complete$totalRNA_average_pseudo_GCcorr[genomicregions_complete$category=="eRNAs"])[1:2]),
            file="PrismTables/3d_TE_eRNAs_densityplot",quote=F,row.names=F)
write.table(data.frame(density(genomicregions_complete$totalRNA_average_pseudo_GCcorr[grep('in_SE',genomicregions_complete$category)])[1:2]),
            file="PrismTables/3d_SE_eRNAs_densityplot",quote=F,row.names=F)

# Analysis for Figure 3e
...
write.table(data.frame(density(genomicregions_complete$totalRNA_average_pseudo_GCcorr[grepl("eRNA|uaRNA",genomicregions_complete$category)&
            ...
            file="PrismTables/3e_sncRNAs_notop2PAS_densityplot",quote=F,row.names=F)
write.table(data.frame(density(genomicregions_complete$totalRNA_average_pseudo_GCcorr[grepl("eRNA|uaRNA",genomicregions_complete$category)&
                                                        genomicregions_complete$canonicalPAS] )[1:2]),
            file="PrismTables/3e_sncRNAs_withtop2PAS_densityplot",quote=F,row.names=F)
...
# Figure 4b (same distribution for randomized controls as in Figure 3)
...
## Figure 4c, e: Analysis of introns in library 
...
# Fig 4c and Extended Data Figure 4
...
```{r Figure 5}
## Start with filtering for spliced wild-type introns in which mutations effectively disrupt splicing
...
# Figure 5a and Extended Data Fig 5a-b
fig5a_EDifg5a_data <- widetable_makeandsave_multi(effectivemutants_in_splicedoriginal_byrunon_averages,
...
## Fig 5c, ED Fig 5d, ED Fig 5e
# First, a MOODS search with a very lenient threshold was used to find anything resembling a 5'SS, this was filtered down to only include matches on the given strand. 
# The sequences of these matches are exported and run through the MaxEnt algorithm (online). 
...
# For each insert, this assigns the highest MaxEnt score of all 5'SS motif matches in it. 
# Inserts are categorized into three groups, where anything under a MaxEnt score of 5 is not considered a real 5'SS. A score of 5-10 is considered medium, >10 is considered strong.
...
full_library_annotations$maxMAXENTscore_postMOODS[is.na(full_library_annotations$maxMAXENTscore_postMOODS)] <- -20
...
EDfig5d_data_forstatistics <- widetable_makeandsave(genomicregions_complete[grepl("eRNA|uaRNA",genomicregions_complete$category) & genomicregions_complete$splicing_status_nascent=="unspliced",],
                                                  data="totalRNA_average_pseudo_GCcorr", grouping_parameter='MaxEnt5ssstrength',subset="sncRNAs_unspliced",keep=F,save=T)


## Check effect of multiple 5'SSs (MaxEnt >= 5)
MOODS_5ss_weak_plusstrand_5plus <- MOODS_5ss_weak_plusstrand[MOODS_5ss_weak_plusstrand$MaxEnt>=5,]

full_library_annotations$nr5SS <- sapply(full_library_annotations$unique_id,function(id){
                                    sum(MOODS_5ss_weak_plusstrand_5plus$unique_id==id)
                                  })

genomicregions_complete$nr5SS <- full_library_annotations$nr5SS[
                                  match(genomicregions_complete$unique_id,full_library_annotations$unique_id)]

# Extended Data Figure 5e
write.table(data.frame(density(genomicregions_complete$totalRNA_average_pseudo_GCcorr[genomicregions_complete$group=="mRNAs_6to179"&
                                                                                      genomicregions_complete$splicing_status_nascent=="unspliced"&
                                                                                      genomicregions_complete$nr5SS==0])[1:2]),
            file="PrismTables/EDfig5e_mRNAs_6to179_unspliced_0_5SS_densityplot.txt",quote=F,row.names=F)
write.table(data.frame(density(genomicregions_complete$totalRNA_average_pseudo_GCcorr[genomicregions_complete$group=="mRNAs_6to179"&
                                                                                      genomicregions_complete$splicing_status_nascent=="unspliced"&
                                                                                      genomicregions_complete$nr5SS==1])[1:2]),
            file="PrismTables/EDfig5e_mRNAs_6to179_unspliced_1_5SS_densityplot.txt",quote=F,row.names=F)

write.table(data.frame(density(genomicregions_complete$totalRNA_average_pseudo_GCcorr[genomicregions_complete$group=="mRNAs_6to179"&
                                                                                      genomicregions_complete$splicing_status_nascent=="unspliced"&
                                                                                      genomicregions_complete$nr5SS>1])[1:2]),
            file="PrismTables/EDfig5e_mRNAs_6to179_unspliced_2ormore_5SS_densityplot.txt",quote=F,row.names=F)


EDfig5e_mRNAs_data_forstatistics <- widetable_makeandsave(genomicregions_complete[genomicregions_complete$group=="mRNAs_6to179"&genomicregions_complete$splicing_status_nascent=="unspliced",],
                                                  data="totalRNA_average_pseudo_GCcorr", grouping_parameter='nr5SS',subset="mRNAs_6to179_unspliced",keep=F,save=T)


write.table(data.frame(density(genomicregions_complete$totalRNA_average_pseudo_GCcorr[grepl("eRNA|uaRNA",genomicregions_complete$category) &
                                                                                      genomicregions_complete$splicing_status_nascent=="unspliced"&
                                                                                      genomicregions_complete$nr5SS==0])[1:2]),
            file="PrismTables/EDfig5e_sncRNAs_6to179_unspliced_0_5SS_densityplot.txt",quote=F,row.names=F)
write.table(data.frame(density(genomicregions_complete$totalRNA_average_pseudo_GCcorr[grepl("eRNA|uaRNA",genomicregions_complete$category) &
                                                                                      genomicregions_complete$splicing_status_nascent=="unspliced"&
                                                                                      genomicregions_complete$nr5SS==1])[1:2]),
            file="PrismTables/EDfig5e_sncRNAs_6to179_unspliced_1_5SS_densityplot.txt",quote=F,row.names=F)

write.table(data.frame(density(genomicregions_complete$totalRNA_average_pseudo_GCcorr[grepl("eRNA|uaRNA",genomicregions_complete$category) &
                                                                                      genomicregions_complete$splicing_status_nascent=="unspliced"&
                                                                                      genomicregions_complete$nr5SS>1])[1:2]),
            file="PrismTables/EDfig5e_sncRNAs_6to179_unspliced_2ormore_5SS_densityplot.txt",quote=F,row.names=F)

EDfig5e_sncRNAs_data_forstatistics <- widetable_makeandsave(genomicregions_complete[grepl("eRNA|uaRNA",genomicregions_complete$category)&genomicregions_complete$splicing_status_nascent=="unspliced",],
                                                  data="totalRNA_average_pseudo_GCcorr", grouping_parameter='nr5SS',subset="sncRNAs_6to179_unspliced",keep=F,save=T)

### 10nt 5'SSs in random backgrounds
...
splicedonors_violinplotdata <- widetable_makeandsave_multi(x=splicedonors_in_background_averages_MaxEntof5[which(splicedonors_in_background_averages_MaxEntof5$splicingeff_runon_average<0.03),],
                                                          ...
                                                          grouping='splicedonor', subset_for_name='splicedonors_unspliced',print_tables=T

# What is in which figure
intron_table$fig5a <- intron_table$name_mutstatus %in% effectivemutants_in_splicedoriginal_byrunon_averages$name_mutstatus
alldata_WT_annotated$fig5c <- alldata_WT_annotated$unique_id %in% genomicregions_complete$unique_id[
  genomicregions_complete$group=="mRNAs_6to179"&genomicregions_complete$splicing_status_nascent=="unspliced"]
splicedonors_in_background_averages$fig5d <- splicedonors_in_background_averages$name_splicedonor %in% 
  splicedonors_in_background_averages_MaxEntof5$name_splicedonor[
      which(splicedonors_in_background_averages_MaxEntof5$splicingeff_runon_average<0.03)]
intron_table$EDfig5a <- intron_table$fig5a
intron_table$EDfig5b <- intron_table$name_mutstatus %in% effectivemutants_in_splicedoriginal_byrunon_averages_noPAS$name_mutstatus
alldata_WT_annotated$EDfig5d <- alldata_WT_annotated$unique_id %in% genomicregions_complete$unique_id[
                                                                      grepl("eRNA|uaRNA",genomicregions_complete$category) &
                                                                              genomicregions_complete$splicing_status_nascent=="unspliced"]
alldata_WT_annotated$EDfig5e <- alldata_WT_annotated$fig5c | alldata_WT_annotated$EDfig5d
splicedonors_in_background_averages$EDfig5f <- splicedonors_in_background_averages$fig5d
```
...
write.table(cbind(alldata_WTscreens,
            ...
            'output/data_WTscreens_Oct4uaRNA_wfigures.txt',sep="\t",quote=F,row.names=T)
write.table(cbind(alldata_14Rikscreens,
                  alldata_14Rik_annotated[,grep('fig',colnames(alldata_14Rik_annotated))]),
            'output/data_14Rikscreens_wfigures.txt',sep="\t",quote=F,row.names=T)
write.table(cbind(alldata_RRP40KDscreens,
                  alldata_RRP40KD_annotated[,grep('fig',colnames(alldata_RRP40KD_annotated))]),
            'output/data_RRP40KDscreens_Oct4uaRNA_wfigures.txt',sep="\t",quote=F,row.names=T)
write.table(intron_table,
            'output/averaged_introns_WTscreens_Oct4uaRNA_wfigures.txt',sep="\t",quote=F,row.names=F)
write.table(splicedonors_in_background_averages,
            'output/averaged_bgnorm_splicedonors_WTscreens_Oct4uaRNA_wfigures.txt',sep="\t",quote=F,row.names=F)
